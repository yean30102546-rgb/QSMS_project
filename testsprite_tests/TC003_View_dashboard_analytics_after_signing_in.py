...
async def run_test():
    ...
    try:
        ...
        # -> Fill the username and password fields and click the submit button to attempt sign-in.
        ...
        # -> Open the 'แดชบอร์ด (Dashboard)' view to load and verify analytics charts are visible.
