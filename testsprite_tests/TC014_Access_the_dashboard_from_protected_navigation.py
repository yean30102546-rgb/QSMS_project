...
async def run_test():
    ...
    try:
        ...
        # -> Fill the username and password fields with QSMS/QSMS and submit the login form.
        ...
        # -> Fill the password field with 'Qsms123' (index 7) and submit the login form (click index 9).
        # password input placeholder="Enter Password"
        elem = page.locator("xpath=/html/body/div/div/div[2]/div/form/div[2]/div/input").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        ...
        # -> Click the 'แดชบอร์ด (Dashboard)' navigation button (index 155) to ensure navigation is done via protected link, then verify the shared analytics summary cards are visible (look for the total count '30').
