...
async def run_test():
    ...
    try:
        ...
        # -> Fill the username and password fields with QSMS, then submit the login form to open the dashboard.
        ...
        # -> Fill the password field (index 5) with 'Qsms123' and then click the submit button (index 9) to attempt signing in.
        # password input placeholder="Enter Password"
        elem = page.locator("xpath=/html/body/div/div/div[2]/div/form/div[2]/div/input").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
