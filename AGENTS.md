...
- เมื่อมี Task ให้ไปดูใน index ว่ามีเรื่องที่เกี่ยวข้องกับ task หรือไม่ ถ้ามีให้ไปดูในหน้านั้น ถ้าไม่มีให้ไปดูใน raw ถ้าไม่มีจริงๆ ค่อยค้นหาจากอินเทอร์เน็ต
