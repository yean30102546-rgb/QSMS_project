                ...
                <div className="flex items-center justify-between gap-3 px-5 py-4 border-b border-slate-100 dark:border-slate-800 shrink-0">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <DialogPrimitive.Description className="text-[11px] text-amber-600 dark:text-amber-400 font-medium">Always Busy Helping • Online</DialogPrimitive.Description>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-1 flex-col overflow-hidden">
                    ...
                    <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
                      <div className="flex justify-center">
                        <span className="text-[10px] font-semibold text-slate-400 dark:text-slate-500 bg-slate-100 dark:bg-slate-800 px-2.5 py-0.5 rounded-full uppercase tracking-wider">
                          Today
                        </span>
                      </div>
                              ...
                              >
                                {m.suggestions.map((chip, cIdx) => (
                                  <button
                                    ...
                                    className="px-3 py-1.5 text-[11px] font-semibold text-amber-600 bg-amber-50 border border-amber-200 rounded-full hover:bg-amber-100 dark:bg-amber-900/30 dark:border-amber-700/50 dark:text-amber-400 dark:hover:bg-amber-900/50 transition-colors shadow-sm"
                                  >
                                    {chip}
                                  </button>
                                ))}
                    ...
                    <div className="px-4 py-3 border-t border-slate-100 dark:border-slate-800 shrink-0 bg-white dark:bg-[#1c1c1e]">
                      {cooldown > 0 && (
                        <div className="flex items-center justify-center gap-2 mb-2 px-3 py-1.5 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200/50 dark:border-amber-700/30">
                          <span className="text-[11px] font-semibold text-amber-700 dark:text-amber-400">⏳ กรุณารอสักครู่ ({cooldown} วินาที) โควตาเต็มครับ</span>
                        </div>
                      )}
                      ...
                      <p className="text-center mt-2 text-[10px] text-slate-400 font-medium flex items-center justify-center gap-1">
                  ...
                  <div className="flex-1 overflow-y-auto p-4 space-y-4">
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <p className="text-[11px] text-slate-400 mt-0.5">อัปโหลด PDF หรือ Excel เพื่อสร้างชุดข้อมูล RAG</p>
                      </div>
                      <label className="flex flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-slate-200 bg-slate-50 p-5 text-center cursor-pointer hover:border-amber-400 hover:bg-amber-50/30 transition dark:border-slate-700 dark:bg-slate-800 dark:hover:bg-slate-800/80">
                        ...
                        <span className="text-[10px] text-slate-400">PDF ≤ 2MB | Excel ≤ 5MB | Image ≤ 5MB</span>
                        <input
                          type="file"
                          multiple
                        ...
                        <AnimatePresence>
                          {uploadQueue.map(q => (
                            ...
                            >
                              ...
                              {q.error && <p className="text-[10px] text-red-500/90 font-medium max-h-24 overflow-y-auto leading-relaxed pr-2 scrollbar-thin scrollbar-thumb-red-200 dark:scrollbar-thumb-red-900/50">{q.error}</p>}
                            </motion.div>
                          ))}
                        </AnimatePresence>
                      </div>
                        ...
                        documents.map(doc => (
                          <div key={doc.id} className="flex items-center justify-between rounded-xl border border-slate-100 bg-white p-3 dark:border-slate-800 dark:bg-[#1c1c1e] hover:border-amber-200 hover:shadow-sm transition">
                            ...
                            <button
                              ...
                              className="flex h-7 w-7 items-center justify-center rounded-lg text-slate-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition shrink-0"
                            >
