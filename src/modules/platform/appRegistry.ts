...
export const portalAppRegistry: PortalAppDefinition[] = [
  ...
  },
  {
    ...
    subtitle: 'Manage engineering files and versions',
    description: 'Centralized cloud storage for customer drawings and internal Master files with AI-powered data extraction.',
    route: 'storage',
    status: 'active',
    accent: 'gold',
  },
