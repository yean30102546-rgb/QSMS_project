...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-[#18181b] text-white shadow hover:bg-[#27272a] focus-visible:ring-[#18181b]",
        destructive:
          "bg-red-500 text-white shadow hover:bg-red-600 focus-visible:ring-red-500",
        outline:
          "border border-[#e4e4e7] bg-white text-[#18181b] shadow-sm hover:bg-[#f4f4f5]",
        secondary:
          "bg-[#f4f4f5] text-[#18181b] shadow-sm hover:bg-[#e4e4e7]",
        ghost:
